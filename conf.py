...
BLOG_TITLE = "Demba Ba"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://demba-ba.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://demba.github.io/blog/"
BLOG_EMAIL = "dembayel@gmail.com"
BLOG_DESCRIPTION = "Musings about life, being an assistant professor, research, and becoming relevant."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/stories/about-me/index.html","About Me"),
        ("/stories/cv/index.html","CV"),
